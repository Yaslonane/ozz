    ...
    <section class="panel">
        ...
        <div class="wrapper">
            <form action="" class="form-horizontal adminex-form" name="" enctype="multipart/form-data" method="post">
                ...
                <div class="row">
                    <h2>слайдер № <?php echo $slider['id'] ?></h2>
                    <div  class="col-sm-offset-1 col-sm-5">
                    <div class="form-group" >
                        <?php if(empty($slider['img'])): ?>
                            <img src="<?php echo DOMAIN; ?>/images/content/service-01.jpg" "/>
                        <?php else: ?>
                            <img width="300 px" src="<?php echo $slider['img']; ?>"/>
                        <?php endif; ?>
                    </div>
                        <input type="hidden" name="id" value="<?php echo $slider['id'] ?>"/>

                        <div class="form-group" >
                            <input class="form-control" name="img" type="text" readonly="readonly" placeholder="Click here to browse the server" value="<?php echo $slider['img'] ?>" onclick="openKCFinder(this)" style="cursor:pointer" />
                        </div>
                ...
                <div  class="col-sm-5">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><input type="text" class="form-control" name="title" value="<?php echo $slider['title']?>"></div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Описание</label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="description" value="<?php echo $slider['description']?>"></div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label">Автор(ы) отзыва</label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="link" value="<?php echo $slider['link']?>"></div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Опубликован</label>
                        <div class="col-sm-10">
                            <select class="form-control m-bot15" name="is_publication">
                                <option value="1" <?php if($slider['is_publication'] == 1):?> selected <?php endif; ?>>Опубликован</option>
                                <option value="0" <?php if($slider['is_publication'] == 0):?> selected <?php endif; ?>>Снят с публикации</option>
                            </select>
                        </div>
                    </div>
                 </div>  
